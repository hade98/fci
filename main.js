        ...
        function resend1(){
          setTimeout(function (){ // wait for 28.5s then send packet
            $("#mp1").text("seq=0");
                ...
                $("#mp1").text("ack=1");
                $("#rec1tdr").animate({top:"46px"},10000,function(){
...
function packet1(){
   $("#mp1").text("seq=0");
	 ...
	 if ($("#rec1td").css("display")!== 'none'){
                ...
                $("#mp1").text("ack=1");
                $("#rec1td").animate({top:"46px"},10000,function(){
                  if($("#rec1td").css("display") == 'none'){
...
function resend2(){
          setTimeout(function(){ // wait for 28.5s then send packet
            $("#mp2").text("seq=1");
                ...
                $("#mp2").text("ack=2");
                $("#rec2tdr").animate({top:"46px"},10000,function(){
...
function packet2(){
   $("#mp2").text("seq=1");
	 ...
	 if ($("#rec2td").css("display")!== 'none'){
                ...
                $("#mp2").text("ack=2");
                $("#rec2td").animate({top:"46px"},11000,function(){
                  if ($("#rec2td").css("display") == 'none') { 
...
function resend3(){
           setTimeout(function(){ // wait for 28.5s then send packet
            $("#mp3").text("seq=2");
                ...
                $("#mp3").text("ack=3");
                $("#rec3tdr").animate({top:"46px"},10000,function(){
...
function packet3(){
  $("#mp3").text("seq=2");
	 ...
	 if ($("#rec3td").css("display")!== 'none'){
                ...
                $("#mp3").text("ack=3");
                $("#rec3td").animate({top:"46px"},12000,function(){
                  if ($("#rec3td").css("display") == 'none') {
                    resend3()
                  }else
...
function resend4(){
           setTimeout(function(){ // wait for 28.5s then send packet
            $("#mp4").text("seq=3");
                ...
                $("#mp4").text("ack=4");
                $("#rec4tdr").animate({top:"46px"},10000,function(){
...
function packet4(){
  $("#mp4").text("seq=3");
	 ...
	 if ($("#rec4td").css("display")!== 'none'){
                ...
                $("#mp4").text("ack=4");
                $("#rec4td").animate({top:"46px"},13000,function(){
                  if ($("#rec4td").css("display") == 'none') {
                    resend4()
                  }else
...
function resend5(){
           setTimeout(function(){ // wait for 26.5s then send wasted packet
            $("#mp5").text("seq=4");
                ...
                $("#mp5").text("ack=5");
                $("#rec5tdr").animate({top:"46px"},10000,function(){
...
function packet5(){
  $("#mp5").text("seq=4");
	 ...
	 if ($("#rec5td").css("display")!== 'none'){
                ...
                $("#mp5").text("ack=5");
                $("#rec5td").animate({top:"46px"},14000,function(){
                  if ($("#rec5td").css("display") == 'none') {
                    resend5()
                  }else
